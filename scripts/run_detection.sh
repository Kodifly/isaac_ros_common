...
bash /home/kodifly/isaac_ros_common/scripts/bind_audio.sh
...
DOCKER_ARGS+=("--volume /home/kodifly/pulseaudio/pulseaudio.socket:/tmp/pulseaudio.socket")
DOCKER_ARGS+=("--volume /home/kodifly/pulseaudio/pulseaudio.client.conf:/etc/pulse/client.conf")
...
docker run -it --rm \
    ...
    $@ \
    $IMAGE_NAME \
    /workspaces/isaac_ros-dev/src/lrv_bringup/scripts/run_detection.sh